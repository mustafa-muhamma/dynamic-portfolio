...
4. Security review, tests, and performance pass against the live site — re-verify the cold page load now that the bundle endpoint makes it a **single request**.
