...
- [ ] Hardening & launch (deployment live; security/test pass + content/polish remain)
...
2. M5: populate every entity with real content via the dashboard (education, pricing, testimonials are empty) — deferred from M4.
