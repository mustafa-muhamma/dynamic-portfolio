...
- **Approved technology stack (MVP):**
  ...
  - **Deployment:** frontend → Vercel; backend → Railway/Render (provider to be finalized); database → MongoDB Atlas; media → Cloudinary.
...
- Final backend hosting provider: Railway or Render?

---

*The PRD is the source of truth for WHAT is built. Changes here require explicit sign-off.*
